    ...
    return (
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center justify-center gap-6">
          <div className=" style flex styles  flex-col justify-center bg-white p-4 first rounded-sm w-[66%] ">
          ...
          <div className="flex flex-col style justify-center styles w-[20%] items-center  bg-white p-4 h-[208px]  second rounded-sm">
            <div className="flex flex-col gap-4">
              ...
              <button
                className="transparent border-[1px]  text-gray-700 px-4 py-2 rounded transition duration-300 ease-in-out transform  hover:bg-gray-100 hover:text-black hover:scale-105"
