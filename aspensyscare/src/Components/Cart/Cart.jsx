...
import { Accordion, AccordionDetails, AccordionSummary, Box, Button, FormControl, FormControlLabel, Radio, RadioGroup, Typography, Modal } from '@mui/material'
                                ...
                                <AccordionDetails style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
                                    ...
                                    {cart.cartItems &&
                                        cart.cartItems.map((cartItem) => (
                                            ...
                                            <div style={{ width: '95%', display: 'flex', flexDirection: 'raw', flexWrap: 'nowrap', alignItems: 'center', borderBottom: '2px solid #d9d9d9' }}>

                                                {/* ----------------------item box start------------------ */}
                                                <div style={{ width: '45%', display: 'flex', flexDirection: 'raw', alignItems: 'flex-start', padding: '5px', marginTop: '10px' }}>
                                                    <div style={{ width: '50%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: '20px' }}>
                                                        <img width="auto" style={{ backgroundColor: '#d9d9d9' }}
                                                            height={100} alt={cartItem.name} src={`./Image/all_products/${cartItem.product_image}`} />
                                                        <div style={{ width: '100%', display: 'flex', flexDirection: 'raw', justifyContent: 'space-between' }}>
                                                    ...
                                                    <Typography variant='h2'
                                                        style={{ padding: '5px', fontSize: '16px', fontWeight: 600, }}>{cartItem.name}({cartItem.itemSize}ml)
                                                    </Typography>
                                                </div>
                                                {/* ----------------------item box end------------------ */}
                                                {/* ----------------------size box start------------------ */}
                                                <div style={{ width: '20%', padding: '5px', display: 'flex', justifyContent: 'space-around' }}>
                                                    <div><SizeButtom onClick={handleOpendilog} variant='contained' style={{ backgroundColor: 'green' }} > {cartItem.itemSize}ml </SizeButtom></div>
                                                    <Modal
                                                    open={openmod}
                                                ...
                                                {/* ----------------------size box end------------------ */}
                                                {/* ----------------------Quantity box start------------------ */}
                                                <div style={{ width: '20%', padding: '5px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                                    <RemoveCircleRoundedIcon style={{ fontSize: '18px', cursor: 'pointer' }} onClick={() => handleDecreaseCart(cartItem)} />
                                                    <div style={{ width: '30px', height: 'max-content', textAlign: 'center' }}>{cartItem.cartQuantity}</div>
                                                    <AddCircleRoundedIcon style={{ fontSize: '18px', cursor: 'pointer' }} onClick={() => handleAddToCart(cartItem)} />
                                                </div>
                                                {/* ----------------------Quantity box end------------------ */}
                                                {/* ----------------------Price box start------------------ */}
                                                <div style={{ width: '15%', padding: '5px', display: 'flex', justifyContent: 'flex-end' }}>
                                ...
                                <AccordionDetails>
                                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                                        ...
                                        <FormControl sx={{ m: 3 }} error={error} variant="standard" onChange={(e) => takeValue(e)}>
                                            <div style={{ width: '70%', height: '65px', overFlow: 'hidden', display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'flex-start', gap: '1rem' }} >
                        ...
                        <Amountcont>
                            ...
                            <AmountDetailscont >
                                <AmountDetailsrow style={{ borderBottom: '1.4px solid gray' }}>
                                    ...
                                    <Typography>
                                        <div style={{ minWidth: '70px', height: 'max-content', textAlign: 'center' }}>
                                ...
                                <AmountDetailsrow style={{ borderBottom: '1.4px solid gray', }}>
                                    ...
                                    <Typography style={{ display: 'flex', flexWrap: 'nowrap', alignItems: 'center' }}>
                                        ...
                                        <div style={{ width: '70px', height: 'max-content', textAlign: 'center' }}>
